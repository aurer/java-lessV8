...
public class LessException extends Exception
{
	...
	private String stack; // the javascript exception like typeerror
	private int index;
	private int line;
	private int callLine;
	private int column;
	private List<String> extract; // the stacktrace from lessexception
	...
	public LessException(Exception e)
	{
		super(e);
	}
	...
	public LessException(V8Object v8Object)
	{
		...
		// all object variables has to be type-checked if it is defined
		// if the key doesnt exist (or undefined) and calling getString() will cause Exception
		...
		// the stacktrace from less compiler
